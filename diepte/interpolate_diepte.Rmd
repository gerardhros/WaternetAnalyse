...
Er wordt aangegeven dat er verschillende covariabelen zijn die een (zwake) invloed hebben op de waterdiepte.  Namelijk, de waterdiepte is groter wanneer het peil hoger is (en AHN dus ook), wanneer de kwel negatief is, wanneer de theoretische diepte hoger is, wanneer het water breder is en wanneer de slibdiepte groter is.
