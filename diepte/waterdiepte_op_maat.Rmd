...
# d1 <- hybi[hybi$fewsparameter == c('WATDTE_m','WATERBTE_m', 'SLIBDTE_m'),.(mean = mean(meetwaarde,na.rm=T), median = quantile(meetwaarde,probs = c(0.50), na.rm=T), perc90 = quantile(meetwaarde,probs = c(0.90), na.rm=T), perc95 = quantile(meetwaarde,probs = c(0.95), na.rm=T)), by = c('locatie.EAG','jaar','fewsparameter')]
