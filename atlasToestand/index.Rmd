...
gKRW<- st_read("../data/WBPKRW20191220.gpkg")%>% st_transform(proj4.google)
...
```{r kaartKRW4, fig.cap = 'Overzicht van gemiddelde EKR scores per EAG op de maatlat Overige waterflora in de periode 2006 t/m 2015 links en 2015 t/m 2019 rechts.', echo = FALSE, message = FALSE, warning = FALSE, out.width="100%", fig.show ='hold'}

tabset <- tabelEKRPerWLEnEAGPerJaar(EKRset)
...
krw <- KRWmapEAG(tabset[tabset$wbmethode == "Maatlatten2018 Ov. waterflora" ,], maatlat = "2V1 Overige waterflora", param = "oordeel")
tabset1 <- tabset[tabset$jaar < '2015',]
tabset2 <- tabset[tabset$jaar > '2014',]

combineWidgets(
    ncol = 2, colsize = c(1, 1),
    KRWmapEAG(tabset1, maatlat = "2V1 Overige waterflora", param = "oordeel"),
    KRWmapEAG(tabset2, maatlat = "2V1 Overige waterflora", param = "oordeel")
)
...
In afbeelding \@ref(fig:kaartKRW3) staat de actuele toestand van vegetatie weergegeven. Deze is gebaseerd op metingen in meerdere jaren. De gemeten vegetatie laat van nature fluctuaties zien in de tijd en een gemiddelde van verschillende jaren geeft een betrouwbaarder beeld van de ecologische toestand. In de systematiek van de KRW wordt een oordeel gegeven door dit ‘slepend gemiddelde’ van EKR scores per gebied te vergelijken met een doel. 
...
if(outputF == "html"){
KRWmapEAG(tabset[tabset$wbmethode == "Maatlatten2018 Ov. waterflora" ,], maatlat = "2V1 Overige waterflora", param = 'ekr3jr')
}
...
if(outputF == "html"){
KRWmapEAG(tabset[tabset$wbmethode == "Maatlatten2018 Ov. waterflora" ,], maatlat = "2V1 Overige waterflora", param = 'doel')
}
if(outputF == "word"){
krw <-
KRWmapEAG(tabset[tabset$wbmethode == "Maatlatten2018 Ov. waterflora" ,], maatlat = "2V1 Overige waterflora", param = 'doel')
...
trendkrw <- trendkrw[trendkrw$estimate < -0.01| trendkrw$estimate > 0.01,] 
...
In 65% van de gebieden is de ontwikkeling in ecologische waterkwaliteit min of meer stabiel of zijn er onvoldoende gegevens beschikbaar om de ontwikkeling goed in beeld te brengen. 
...
```{r trend1, fig.cap = 'Overzicht van de trend in EKR scores op de maatlat overige waterflora per ecologisch analysegebied tussen 2006 en 2017', echo = FALSE, message = FALSE, warning = FALSE, out.width="100%", fig.show='hold'}
krw<-
...
combineWidgets(
    ncol = 4, colsize = c(1,1),
    ekrmap3(EKRset[EKRset$jaar >= '2006' & EKRset$jaar < '2010' & EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Vis",],
                 maatlat = "4VI1 Vis-kwaliteit" ),
    ekrmap3(EKRset[EKRset$jaar >= '2010' & EKRset$jaar < '2013'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Vis",],
                 maatlat = "4VI1 Vis-kwaliteit" ),
    ekrmap3(EKRset[EKRset$jaar >= '2013' & EKRset$jaar < '2016'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Vis",], 
                 maatlat = "4VI1 Vis-kwaliteit" ),
    ekrmap3(EKRset[EKRset$jaar >= '2016' & EKRset$jaar < '2020'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Vis",], 
                 maatlat = "4VI1 Vis-kwaliteit" ))
