...
trendekr <- readRDS('./data/trendekr.rds') %>% as.data.table()
trendekreag <- readRDS('./data/trendekreag.rds')  %>% as.data.table()
ekrtrend <- readRDS('./data/ekrtrend.rds') %>% as.data.table() #alleen hoofd, gewogen
ekrtrendeag <- readRDS('./data/ekrtrendeag.rds')  %>% as.data.table() #alleen hoofdmaatlat
...
# Inleiding
De informatie over de huidige situatie en ontwikkelingen van het aquatisch ecosysteem in de regio Amstel, Gooi en Vechtstreek is in deze rapportage gebundeld in een atlas met thema kaarten. De ecologische doelstellingen van Amstel, Gooi en Vecht en de huidige ecologische kwaliteit zijn verbeeld in de afbeeldingen hieronder.  
...
map <- draw_map(pl = KRW, dt =ekr_scores1, bkpl = EAG,
                 ...
                 col_area_sf = "OWMIDENT", col_area_dt = "KRW_SGBP3",
                 filename = "map_oordeel_waterlichaam0609.jpg")
...
combineWidgets(
    ...
    KRWmapEAG(gEAG,ekr_scores2[ekr_scores2$wbmethode == "Maatlatten2018 Ov. waterflora" ,], 
              maatlat = "2V1 Overige waterflora", param = "doel_gemhndprs"),   KRWmapEAG(gEAG,ekr_scores2[ekr_scores2$wbmethode == "Maatlatten2018 Ov. waterflora" ,], 
              maatlat = "2V1 Overige waterflora", param = "oordeelv2"),
    KRWmapEAG(gEAG,ekr_scores2[ekr_scores2$wbmethode == "Maatlatten2018 Ov. waterflora" ,], 
              maatlat = "2V1 Overige waterflora", param = "doelgatv2")
)


saveWidget(krw, "waterfloraekrdoeloordeelgatv2.html", selfcontained = FALSE)
#webshot("waterflora.html", file = "waterflora.png")
...
p<- ggplot(srtbelas, aes(x= wp_min_sum, y= EKR3jr, label = paste0(waterlichaam), col = w_debiet))+
    geom_jitter() +
...
combineWidgets(
    ...
    ekrmap2(EKRset[EKRset$jaar >= '2006' & EKRset$jaar < '2009'& EKRset$Waardebepalingsmethode.code %in% c("Maatlatten2018 Ov. waterflora"),], gEAG, maatlat = "2V1 Overige waterflora",col=col,labels=labels),
    ekrmap2(EKRset[EKRset$jaar >= '2009' & EKRset$jaar < '2012'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Ov. waterflora",], gEAG, maatlat = "2V1 Overige waterflora",col=col,labels=labels),
    ekrmap2(EKRset[EKRset$jaar >= '2012' & EKRset$jaar < '2015'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Ov. waterflora",], gEAG, maatlat = "2V1 Overige waterflora",col=col,labels=labels),
    ekrmap2(EKRset[EKRset$jaar >= '2015' & EKRset$jaar < '2020'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Ov. waterflora",], gEAG, maatlat = "2V1 Overige waterflora",col=col,labels=labels))
...
combineWidgets(
    ...
    chlorofylA(wq1[wq1$jaar < '2013'& wq1$jaar > '2005',], gEAG),
    chlorofylA(wq1[wq1$jaar > '2012'& wq1$jaar < '2018',], gEAG)
)
...
combineWidgets(
    ncol = 4, 
    ekrmap2(EKRset[EKRset$jaar >= '2006' & EKRset$jaar < '2009'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Fytoplankton",], gEAG, maatlat = "1F1 Fytoplankton-kwaliteit",col=col,labels=labels),
    ekrmap2(EKRset[EKRset$jaar >= '2009' & EKRset$jaar < '2012'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Fytoplankton",], gEAG, maatlat = "1F1 Fytoplankton-kwaliteit",col=col,labels=labels),
    ekrmap2(EKRset[EKRset$jaar >= '2012' & EKRset$jaar < '2015'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Fytoplankton",], gEAG, maatlat = "1F1 Fytoplankton-kwaliteit",col=col,labels=labels),
    ekrmap2(EKRset[EKRset$jaar >= '2015' & EKRset$jaar < '2020'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Fytoplankton",], gEAG, maatlat = "1F1 Fytoplankton-kwaliteit",col=col,labels=labels))
...
combineWidgets(
    ncol = 4, 
    ekrmap2(EKRset[EKRset$jaar >= '2006' & EKRset$jaar < '2009'& EKRset$Waardebepalingsmethode.code %in% c("Maatlatten2018 Macrofauna"),], gEAG, maatlat = "3M1 Macrofauna-kwaliteit",col=col,labels=labels),
    ekrmap2(EKRset[EKRset$jaar >= '2009' & EKRset$jaar < '2012'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Macrofauna",], gEAG, maatlat = "3M1 Macrofauna-kwaliteit",col=col,labels=labels),
    ekrmap2(EKRset[EKRset$jaar >= '2012' & EKRset$jaar < '2015'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Macrofauna",], gEAG, maatlat = "3M1 Macrofauna-kwaliteit",col=col,labels=labels),
    ekrmap2(EKRset[EKRset$jaar >= '2015' & EKRset$jaar < '2020'& EKRset$Waardebepalingsmethode.code == "Maatlatten2018 Macrofauna",], gEAG, maatlat = "3M1 Macrofauna-kwaliteit",col=col,labels=labels))
...
gKRW <- gKRW %>% dplyr::group_by(OWMIDENT,OWMNAAM) %>% dplyr::summarize()
eag_wl1 <- eag_wl %>% dplyr::group_by(KRW_SGBP3,watertype) %>% dplyr::summarize()
gKRW <- merge(gKRW, eag_wl1[,c('KRW_SGBP3','watertype')], by.x = "OWMIDENT", by.y = "KRW_SGBP3", all.x = TRUE, all.y = F)%>% st_transform(4326)
# krw <-
krwmap(gKRW, gEAG)
