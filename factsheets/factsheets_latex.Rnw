...
lx_monwens <- out$waterlichamenwl$MonitoringAnalyseWensen
...
pESFtab[,oms_latex := gsub('°',' graden',oms_latex)]
...
@
  ...
  \posterbox[blankest,interior engine=path,height=2cm,halign=center,valign=center,fontupper=\bfseries\large,colupper=black]{name=title,column=1,span=8,below=top}{\resizebox{26cm}{!}{\bfseries \Sexpr{lx_title}}}
...
Het waterlichaam \Sexpr{lx_naam} \Sexpr{lx_code} heeft watertype "\Sexpr{lx_wtypeoms} (\Sexpr{lx_wtype})" en bestaat uit de deelgebieden: \Sexpr{lx_deelgebied}. \\  \Sexpr{lx_karakterschets} Onze gebiedspartners zijn provincie \Sexpr{lx_prov} en gemeente(n) \Sexpr{lx_gem}. Het waterlichaam \Sexpr{lx_naam} heeft de status \Sexpr{lx_status} en is in eigendom van \Sexpr{lx_owner}.}
 ...
 %add reference methodology information in the bottom
  ...
  % Add the top row with title
  \posterbox[blankest,interior engine=path,height=2.6cm,halign=center,valign=center,fontupper=\bfseries,colupper=black]{name=title,column=1,span=10,below=top}{
  \resizebox{24cm}{!}{\bfseries \Sexpr{lx_title}}\\[3mm]
  ...
  \posterbox[skin=standard,colframe=white,sharp corners = all,height = 6cm,boxrule=0.5mm,valign=center]{name=maatregelen,column=1,span=10,below=title}{
    \centering
    \includegraphics[height = 5cm,keepaspectratio,valign=M]{\Sexpr{mapGauge}}
  }
  
   % add frame for the ESF tabel plus explanation
  \posterbox[adjusted title=Overzicht van maatregelen,fonttitle=\bfseries\scshape,sharp corners = all,boxrule = 0.5mm]{name=esf,column=1,span=10,between = maatregelen and ref}{
...
knitr::kable(maatregelen2[,1:8], format = "latex",align = 'l',escape = FALSE) %>% 
          ...
          column_spec(3, width = "5cm",border_right = F,color = "black") %>%
          column_spec(4, width = "13cm",border_right = F,color = "black") %>%
          column_spec(5:8, width = "2cm", border_right = F,color = "black")  %>%
...
@
 ...
 %add reference methodology information in the bottom
  ...
  \begin{tcbposter}[
   ...
   % Add the top row with title
  \posterbox[blankest,interior engine=path,height=2.6cm,halign=center,valign=center,fontupper=\bfseries,colupper=black]{name=title,column=1,span=6,below=top}{
  \resizebox{24cm}{!}{\bfseries \Sexpr{lx_title}}\\[3mm]
  ...
  \posterbox[adjusted title=Motivering KRW status en herbegrenzing,fonttitle=\bfseries\scshape,valign=top,height = 8cm]{name=krwstatus,column=1,span=3,below=title}{
    \vspace{5mm}
    \Sexpr{lx_motstat}
    \vspace{5mm}
  }
  ...
  \posterbox[adjusted title=Monitoringswensen,fonttitle=\bfseries\scshape,valign=top,height = 8cm]{name=monwens,column=4,span=3,below=title}{
  \vspace{5mm}
  \Sexpr{lx_monwens}
  \vspace{5mm}
  }  
  ...
  \posterbox[adjusted title=ESF1 productiviteit,fonttitle=\bfseries\scshape,valign=center,height = 9cm]{name=p3fig1,column=1,span=2,below=monwens}{
  \centering
  ...
  \posterbox[adjusted title=ESF2 lichtklimaat,fonttitle=\bfseries\scshape,valign=center,height = 9cm]{name=p3fig2,column=3,span=2,below=monwens}{
  \centering
  ...
  \posterbox[adjusted title=ESF4 Waterdiepte,fonttitle=\bfseries\scshape,valign=center,height = 9cm]{name=p3fig3,column=5,span=2,below=monwens}{
  \centering
  ...
  \posterbox[adjusted title=ESF1 en 3 waterbodem,fonttitle=\bfseries\scshape,valign=center,height = 9cm]{name=p3fig4,column=1,span=2,below=p3fig1}{
  \centering
   ...
   % add frame for ESF1 en 3 waterbodem
  \posterbox[adjusted title=ESF1 en 3 waterbodem,fonttitle=\bfseries\scshape,valign=center,height = 9cm]{name=p3fig5,column=3,span=2,below=p3fig1}{
  \centering
