...
<br>
Het waterlichaam ligt in de provincie(s) `r out$waterlichamenwl$prov` en gemeente(n) `r out$waterlichamenwl$gem`. `r if(!unique(out$waterlichamenwl$Gebiedpartners) %in% ""){paste0("Andere gebiedspartners zijn ",unique(out$waterlichamenwl$Gebiedpartners),".")}`
