...
## Bron {data-height=50}
Deze factsheet is gebaseerd op de KRW toetsing aan (maatlatten 2018) uit 2019, begrenzing waterlichamen 2015-2021, hydrobiologische data 2006-2018 en conceptmaatregelen en doelen voor SGBP3 `r if(!is.na(out$waterlichamenwl$Literatuurverwijzing)){paste0(" en ",out$waterlichamenwl$Literatuurverwijzing)}`.
