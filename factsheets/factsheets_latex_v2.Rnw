...
@
 ...
 %add reference methodology information in the bottom
  \posterbox[blankest,interior engine=path,height=0.6cm,fontupper=\small,colupper=black]{name=ref,column=1,span=10,above=bottom}{
   ...
   % reduce size of the font
  \fontsize{8}{9.6}\selectfont Auteur: Laura Moria, laura.moria@waternet.nl. Deze factsheet is gebaseerd op de KRW toetsing aan (maatlatten 2018) uit 2019, begrenzing waterlichamen 2015-2021, hydrobiologische data 2006-2018 en conceptmaatregelen en doelen voor SGBP3 en \Sexpr{out$waterlichamenwl$Literatuurverwijzing}. De R- en LaTeX-code om deze pdf's te genereren is ontwikkeld door Gerard H. Ros, gerard.ros@waternet.nl.
    }  
