...
if(nrow(maatregelen2)>4){
  ...
  if(grepl('botshol',tolower(out$my_title2))){cf = 4500 / tsize}
  ...
  if(grepl('gaasper',tolower(out$my_title2))){cf = 3800 / tsize} 
  if(grepl('hethol',tolower(out$my_title2))){cf = 6600 / tsize}
  if(grepl('loenderveenoost',tolower(out$my_title2))){cf = 4700 / tsize}
  ...
  if(grepl('spiegelplas',tolower(out$my_title2))){cf = 6500 / tsize}
  if(grepl('wijdeblik',tolower(out$my_title2))){cf = 4000 / tsize}
  if(grepl('waterleidingplas',tolower(out$my_title2))){cf = 2000 / tsize}
  if(grepl('naardermeer',tolower(out$my_title2))){cf = 4300 / tsize}
  if(grepl('molenpolder',tolower(out$my_title2))){cf = 6500 / tsize}
  if(grepl('noorderijplas',tolower(out$my_title2))){cf = 4500 / tsize}
  if(grepl('ouderkerkerplas',tolower(out$my_title2))){cf = 4400 / tsize}
  if(grepl('breukeleveenscheplas',tolower(out$my_title2))){cf = 6000 / tsize}
  ...
  if(grepl('hilversumskanaal',tolower(out$my_title2))){cf = 3500 / tsize}
  if(grepl('oostelijkebinnenpolder',tolower(out$my_title2))){cf = 5500 / tsize}
  ...
  if(grepl('vinkeveenseplassen',tolower(out$my_title2))){cf = 6600 / tsize}
