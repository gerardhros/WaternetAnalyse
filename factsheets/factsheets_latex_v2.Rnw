...
eah_message <- paste(eah_m1,eah_m2,eah_m3,eah_m4)
...
maatregelen2[,BeoogdInitiatiefnemer := gsub('Staatsbosbeheer','Staats bosbeheer',BeoogdInitiatiefnemer)]
maatregelen2[,Gebiedspartner := gsub('Waterschap Amstel Gooi en Vecht','Waterschap AGV',Gebiedspartner)]
maatregelen2[,Gebiedspartner := gsub('Natuurmonumenten|natuurmonumenten','Natuur monumenten',Gebiedspartner)]
maatregelen2[,Gebiedspartner := gsub('Staatsbosbeheer','Staats bosbeheer',Gebiedspartner)]
