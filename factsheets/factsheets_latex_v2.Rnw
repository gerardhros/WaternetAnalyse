...
\newcommand{\fon}[1]{\fontfamily{vn}\selectfont}
...
if(nrow(maatregelen2)>4){
  ...
  if(grepl('gaasper',tolower(out$my_title2))){cf = 4500 / tsize} 
  if(grepl('ouderkerkerplas',tolower(out$my_title2))){cf = 6500 / tsize} 
  if(grepl('loosdrechtseplas1tm5',tolower(out$my_title2))){cf = 9500 / tsize} 
  ...
  if(grepl('vaartenvechtstreek',tolower(out$my_title2))){cf = 6200 / tsize}
  if(grepl('vaartengrootmijdrecht',tolower(out$my_title2))){cf = 4000 / tsize}
  ...
  if(grepl('kievitsbuurt',tolower(out$my_title2))){cf = 5400 / tsize}
  ...
  if(grepl('hethol',tolower(out$my_title2))){cf = 4400 / tsize}
  ...
  if(grepl('botshol',tolower(out$my_title2))){cf = 6500 / tsize}
  if(grepl('tussenboezemvinkeveena',tolower(out$my_title2))){cf = 4300 / tsize}
