...
# koppelingen naar EAGS en GAF waar in balansdata (dat) naar verwezen worden moeten bestaan in opp_kenmerken_EAG.csv
...
for (i in 1:nrow(ESFoordelen)){
    ...
    #i=35 # Vecht
    # ronde hoep cerror-pandoc-document-conversion-failed-with-error-1033-execution-halted
