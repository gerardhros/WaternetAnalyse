...
<br>
De toestand in `r waterlichamenwl$OWMNAAM` (zwarte lijnen in de figuur hiernaast) is `r unique(d3$oordeel)`. Het slechts scorende biologische kwaliteitselement is `r as.character(unique(d3$facet_wrap_code))`. 
`r if(!d3$facet_wrap_code %in% "Macrofauna"){unique(paste0("De slechts scorende deelmaatlat van dit kwaliteitselement is ",unique(d3_deel$GHPR),"."))}` 
