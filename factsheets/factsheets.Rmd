...
maatregelen <- fread('../data/maatregelenKRW_20200318.csv')# hier later ook eags of gafs aan toevoegen
# which colnames are character
...
if(dtEST2$KRWWaterlichaamcode %in% c('NL11_1_1')){
  myimages<- "esticon/W4_O1_K_St.jpg" 
}
