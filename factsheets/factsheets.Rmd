...
# EKR measurements
EKRset <- ppr_ekr(ekr1 = EKRset1, ekr2 = EKRset2, eag_wl, doelen)
...
### Het ecosysteem ziet eruit als onderstaand beeld {data-width=350}

```{r chartT, echo = FALSE, message = FALSE, warning=FALSE, out.width= "100%"}
if(nrow(EST_sel)>0){
EST_sel <- merge(EST_sel, eag_wl[,c('GAFIDENT','watertype','StedelijkLandelijk')], by.x = 'EAG', by.y = 'GAFIDENT')
## gather O en W 
...
### Ligging waterlichaam{data-width=325}
...
### Ligging deelgebieden{data-width=325}
