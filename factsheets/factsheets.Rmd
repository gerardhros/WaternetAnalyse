...
De toestand in `r waterlichamenwl$OWMNAAM` (zwarte lijnen in de figuur hiernaast) is `r d3$oordeel`. Het slechts scorende biologische kwaliteitselement is `r as.character(d3$facet_wrap_code)`. `r if(!d3$facet_wrap_code %in% "Macrofauna"){paste0("De slechts scorende deelmaatlat van dit kwaliteitselement is ",d3_deel$GHPR,".")}` 
`r if(d3_deel$GHPR == 'Abundantie groeivormen macrofyten'){paste0("De slechts scorende indicator van deze deelmaatlat is ", d3_deelptn$GHPR,".")}``r ifelse(is.na(waterlichamenwl$Toestand),"<br>",waterlichamenwl$Toestand)`
<br>

**Oorzaken op hoofdlijnen**
`r ifelse(is.na(waterlichamenwl$Oorzaken),"<br>",waterlichamenwl$Oorzaken)` 
<br>

**Maatregelen op hoofdlijnen**
`r ifelse(is.na(waterlichamenwl$Maatregelen),"<br>",waterlichamenwl$Maatregelen)` 
<br>
